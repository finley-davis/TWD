...
plt.subplots_adjust(left=0.50, wspace=0.5, hspace=0.3)

#add labels
fig.text(0.08, 0.92, '(a)', fontsize=16, fontweight='bold')
fig.text(0.55, 0.92, '(b)', fontsize=16, fontweight='bold')
fig.text(0.08, 0.48, '(c)', fontsize=16, fontweight='bold')
fig.text(0.55, 0.48, '(d)', fontsize=16, fontweight='bold')
